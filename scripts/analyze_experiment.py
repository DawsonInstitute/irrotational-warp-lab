...
def main():
    ...
    if sweep_2d_path.exists() and opt_path.exists():
        ...
        print("1. The Rodal-like irrotational potential produces negative energy regions")
        print("   in all tested configurations (σ ∈ [2, 10], v ∈ [0.8, 2.5]).")
        print()
        print("2. Best configuration from 2D sweep:")
        ...
        print()
        print("3. Hybrid optimizer confirms this trend:")
        ...
        print()
        print("4. Irrotational smoothing (higher σ) does NOT eliminate negatives,")
        print("   but SHARPER walls (lower σ) minimize |E⁻| magnitude.")
        print()
        print("5. Lower velocities reduce negative energy fraction.")
        print()
